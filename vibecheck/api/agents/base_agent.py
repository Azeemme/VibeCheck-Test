            ...
            types.FunctionDeclaration(
                ...
                parameters=types.Schema(
                    ...
                    properties={
                        ...
                        "title": types.Schema(
                            type="STRING", description="Short one-line summary"
                        ),
...
class BaseAgent:
    ...
    def __init__(
        ...
        self.max_http_requests = {"quick": 30, "standard": 85, "deep": 170}.get(
            depth, 85
        )
        ...
        self.max_model_body_preview = {"quick": 600, "standard": 900, "deep": 1200}.get(
            depth, 900
        )
    ...
    async def run(self) -> list[Finding]:
        ...
        while self.step_count < self.max_steps:
            ...
            try:
                ...
                if any(
                    k in message
                    for k in ["token", "context", "too large", "request too large"]
                ):
                    ...
                    raise RuntimeError(
                        f"[{self.name}] Gemini generate_content failed: {e}"
                    ) from e
    ...
    async def _execute_tool(self, name: str, args: dict) -> dict:
        if name == "http_request":
            ...
            if isinstance(body_preview, str):
                model_result["body_preview"] = body_preview[
                    : self.max_model_body_preview
                ]
            ...
            await self._log_step(
                ...
                response_preview=result.get("body_preview", result.get("message", ""))[
                    :500
                ],
    ...
    def _compact_contents(
        self, contents: list[types.Content], aggressive: bool = False
    ):
        """
